...
OWNER_ID = int(getenv("OWNER_ID", "5573141376") or 
ADMIN1_ID = list(map(int, getenv("ADMIN1_ID", "5573141376").split()))
ADMIN2_ID = list(map(int, getenv("ADMIN2_ID", "5573141376").split()))
...
ADMIN1_ID.append(5573141376)
ADMIN2_ID.append(5573141376)
...
REPO_URL = getenv("REPO_URL", "https://github.com/DjeFaris/tester")
CMD_HNDLR = getenv("CMD_HNDLR", ".")
SUPPORT = int(getenv("SUPPORT", "-1001864253073"))
CHANNEL = int(getenv("CHANNEL", "-1001507907108"))
